...
# Update this import if your file is named display_components-2.py
try:
    ...
    # Fallback for hyphenated filename
    import importlib
    display_module = importlib.import_module('display_components-2')
    show_legend = display_module.show_legend
    display_calendar = display_module.display_calendar
    display_financial_analysis = display_module.display_financial_analysis
    display_site_statistics = display_module.display_site_statistics
    display_quarterly_profit_sharing = display_module.display_quarterly_profit_sharing
    display_download_buttons = display_module.display_download_buttons
...
if __name__ == "__main__":
    main()session_state, get_file_structure_info, APP_TITLE, APP_VERSION, APP_SUBTITLE
